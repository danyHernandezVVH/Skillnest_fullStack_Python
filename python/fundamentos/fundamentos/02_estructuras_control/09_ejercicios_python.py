...
# Desarrolla un programa que solicite al usuario cuántos números pares 
# desea ver ($n$). El programa debe imprimir los 
...
# Pide al usuario su año de nacimiento. Calcula su edad y muestra si es 
# mayor de edad (18+). Si tiene menos de 18, indica cuántos años le 
# faltan para la mayoría de edad.
...
# Solicita el precio de un producto y la cantidad 
# comprada. Si el total supera los $100, aplica un 
# 15% de descuento. Muestra el subtotal, el descuento 
...
def aplicarDescuento():
    ...
    print(f"El subtotal es: {producto}. El descuento aplicado es: {descuento}. Y el total del producto es: {total}")
...
# Solicita un número entero y muestra su tabla 
# de multiplicar del 1 al 12, pero solo muestra 
# lo resultados que sean múltiplos de 3.
...
#  El ciclo debe terminar cuando el usuario ingrese un número 
# negativo. Al final, muestra la suma total (sin incluir el negativo).
# venta de waffles siguiente clase
...
# Randy y Jonathan +1 décima

# 11. Filtro de Arreglos
# Dado un arreglo de números generado por el usuario, crea un 
# nuevo arreglo que contenga solo los números que sean mayores a 50.
...
# Daniel Jimenez +1 décima

# 12. Buscador de Elementos
# Crea una lista de 10 ciudades. Pide al usuario que ingrese el nombre de una ciudad 
# y el programa debe decir si la ciudad se encuentra en la lista y en qué índice (posición) está.
...
def inventario():
    ...
    #Ignacio Diaz - Alexiel Retamales +1
...
while continuar:
    ...
    if opcion == "1":
        ...
        print("\nEjercutando ejercicio 7: ")
        contadorVocales()
    elif opcion == "8":
        print("\nEjercutando ejercicio 8: ")
        validacion()
    elif opcion == "9":
        print("\nEjercutando ejercicio 9: ")
        registroNombres()
    elif opcion == "10":
        print("\nEjercutando ejercicio 10: ")
        promedioNotas() 
    elif opcion == "11":
        print("\nEjercutando ejercicio 11: ")
        filtroArreglos()
    elif opcion == "12":
        print("\nEjercutando ejercicio 12: ")
        buscadorElemento()
    elif opcion == "13":
        print("\nEjercutando ejercicio 13: ")
        inventario()
    elif opcion == "14":
        print("\nEjercutando ejercicio 14: ")
        listaCompras()
    elif opcion == "15":
        print("\nEjercutando ejercicio 15: ")
        analisisTemperatura()
    else:
